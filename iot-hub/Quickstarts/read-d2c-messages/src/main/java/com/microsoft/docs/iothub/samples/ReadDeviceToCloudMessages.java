...
public class ReadDeviceToCloudMessages {
  ...
  private static final String eventHubsCompatibleEndpoint = "sb://ihsuprodmlres004dednamespace.servicebus.windows.net/";

  // az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
  private static final String eventHubsCompatiblePath = "iothub-ehub-azuremeetu-2036611-7c1324200b";

  // az iot hub policy show --name service --query primaryKey --hub-name {your IoT Hub name}
  private static final String iotHubSasKey = "W+TgGprwPR6VY6wxvltgNU+HHVnpC031m8zgCQjGziQ=";
